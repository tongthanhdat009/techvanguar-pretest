...
<aside class="client-sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <!-- My Decks -->
        <a href="{{ route('client.dashboard').'#my-decks' }}"
           class="nav-item {{ request()->routeIs('client.dashboard') && request()->has('my-decks') ? 'active' : '' }}">
            <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <a href="{{ route('client.decks.create') }}"
           class="nav-item {{ request()->routeIs('client.decks.create') ? 'active' : '' }}">
            ...
            <span class="nav-text">Create Deck</span>
        </a>

        <!-- Study Now (with badge if cards due) -->
        <a href="{{ route('client.study.all') }}"
           class="nav-item {{ request()->routeIs('client.study.*') ? 'active' : '' }} nav-item-primary">
            ...
            <span class="nav-text">Study Now</span>
            @if($dueCount > 0)
        ...
        <!-- Community Decks -->
        <a href="{{ route('client.dashboard').'#community' }}"
           class="nav-item {{ request()->routeIs('client.dashboard') && request()->has('community') ? 'active' : '' }}">
            <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <!-- User Stats Summary (Bottom of sidebar) -->
