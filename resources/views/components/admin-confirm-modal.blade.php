    ...
    <div class="flex min-h-full items-center justify-center">
        <div class="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl">
            <div class="flex items-start justify-between gap-4">
                ...
                <button type="button" class="rounded-full p-2 text-slate-400 transition hover:bg-slate-100 hover:text-slate-700" data-confirm-cancel aria-label="Close confirmation dialog">
            ...
            <div class="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                ...
                <button type="button" class="rounded-2xl bg-rose-600 px-4 py-2.5 font-semibold text-white transition hover:bg-rose-700" data-confirm-accept data-theme="danger">
                    Confirm
                </button>
            </div>
        </div>
